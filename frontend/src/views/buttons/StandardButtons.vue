<template>
  <div>
    <CCard>
      ...
      <CCardBody>
        ...
        <CRow class="align-items-center mt-3">
          <CCol col="12" xl class="mb-3 mb-xl-0"> Active State </CCol>
          <CCol col="6" sm="4" md="2" xl class="mb-3 mb-xl-0">
        ...
        <CRow class="align-items-center mt-3">
          <CCol col="12" xl class="mb-3 mb-xl-0"> Disabled </CCol>
          <CCol col="6" sm="4" md="2" xl class="mb-3 mb-xl-0">
    ...
    <CCard>
      ...
      <CCardBody>
        <p>Use <code>variant="outline"</code> prop</p>
        <CRow class="align-items-center">
          <CCol col="12" xl class="mb-3 mb-xl-0"> Normal </CCol>
          <CCol col="6" sm="4" md="2" xl class="mb-3 mb-xl-0">
    ...
    <CCard>
      ...
      <CCardBody>
        ...
        <CRow class="align-items-center">
          <CCol col="2" xl class="mb-3 mb-xl-0"> Small </CCol>
        ...
        <CRow class="align-items-center mt-3">
          <CCol col="2" xl class="mb-3 mb-xl-0"> Normal </CCol>
          <CCol col="2" class="mb-3 mb-xl-0 text-center">
        ...
        <CRow class="align-items-center mt-3">
          <CCol col="2" xl class="mb-3 mb-xl-0"> Large </CCol>
          <CCol col="2" class="mb-3 mb-xl-0 text-center">
        ...
        <CRow>
          <CCol sm xs="12" class="text-center mt-3">
            <CButton
              variant="outline"
              color="primary"
              v-model:pressed="togglePress"
              >Primary {{ togglePress ? 'On ' : 'Off' }}</CButton
            >
          </CCol>
          <CCol sm xs="12" class="text-center mt-3">
            <CButton
              ...
              color="secondary"
              v-model:pressed="togglePress"
              >Secondary {{ togglePress ? 'On ' : 'Off' }}</CButton
            >
          </CCol>
          <CCol sm xs="12" class="text-center mt-3">
            <CButton
              ...
              color="success"
              v-model:pressed="togglePress"
              >Success {{ togglePress ? 'On ' : 'Off' }}</CButton
            >
          </CCol>
          <CCol sm xs="12" class="text-center mt-3">
            <CButton
              ...
              color="info"
              v-model:pressed="togglePress"
              >Info {{ togglePress ? 'On ' : 'Off' }}</CButton
            >
          </CCol>
          <CCol sm xs="12" class="text-center mt-3">
            <CButton
              ...
              color="warning"
              v-model:pressed="togglePress"
              >Warning {{ togglePress ? 'On ' : 'Off' }}</CButton
            >
          </CCol>
          <CCol sm xs="12" class="text-center mt-3">
            <CButton
              ...
              color="danger"
              v-model:pressed="togglePress"
              >Danger {{ togglePress ? 'On ' : 'Off' }}</CButton
            >
          </CCol>
        </CRow>
      </CCardBody>
